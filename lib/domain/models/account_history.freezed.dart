...
mixin _$AccountHistory {
 ...
 int get id; int get accountId; EnumChangeType get changeType; AccountState get previousState; AccountState get newState; DateTime get changeTimestamp; DateTime get createdAt;
...
@useResult
$Res call({
 int id, int accountId, EnumChangeType changeType, AccountState previousState, AccountState newState, DateTime changeTimestamp, DateTime createdAt
});
