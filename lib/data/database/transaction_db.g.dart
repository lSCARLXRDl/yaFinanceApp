...
abstract class _$TransactionDb extends GeneratedDatabase {
  _$TransactionDb(QueryExecutor e) : super(e);
  $TransactionDbManager get managers => $TransactionDbManager(this);
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [transactionItem];
}
...
class $$TransactionItemTableFilterComposer
    extends Composer<_$TransactionDb, $TransactionItemTable> {
...
class $TransactionDbManager {
  final _$TransactionDb _db;
  $TransactionDbManager(this._db);
